...
namespace crmSeries.Core.Features.Companies
{
    ...
    public class GetCompaniesPagedRequest : IRequest<PagedQueryResult<Company>>
    {
        public PagedQueryRequest Query { get; set; }
    }

    public class GetCompaniesPagedRequestHandler : IRequestHandler<GetCompaniesPagedRequest, PagedQueryResult<Company>>
    {
        ...
        public Task<Response<PagedQueryResult<Company>>> HandleAsync(GetCompaniesPagedRequest request)
        {
            var result = new PagedQueryResult<Company>();
